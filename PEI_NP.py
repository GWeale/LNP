...
y = df[['PEI Ratio', 'NP Ratio']].values
...
model = Net(input_size=3, output_size=2)  
...
results[['PEI Ratio', 'NP Ratio']] = predictions
...
print("\nTop 5 Ratios Predicted to Achieve Desired Outputs (Excluding PBA Ratio):")
print(top_results[['PEI Ratio', 'NP Ratio', 'Score']])

results.to_csv('optimal_ratios_excluding_pba.csv', index=False)
